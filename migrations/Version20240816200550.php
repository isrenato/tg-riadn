...
final class Version20240816200550 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        $this->addSql('CREATE TABLE location (id INT AUTO_INCREMENT NOT NULL, address VARCHAR(255) NOT NULL, processed TINYINT(1) NOT NULL, is_current TINYINT(1) NOT NULL, telegram_user_id INT NOT NULL, INDEX IDX_5E9E89CBFC28B263 (telegram_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
